 ...
 */
class Odoswitch_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Odoswitch\\Controller\\Home' => 'getHomeService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Odoswitch\\Kernel', 'Odoswitch\\Controller\\Home']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Odoswitch_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Odoswitch_KernelDevDebugContainer',
